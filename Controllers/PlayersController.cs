...
namespace SportLeague.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public PlayersController(SportsLeaguesDbContext context)
        {
            _context = context;    
        }
        ...
        {
            var sportsLeaguesDbContext = _context.Players.Include(p => p.Team);
        ...
        public async Task<IActionResult> Create([Bind("PlayerId,Name,Stats,TeamId")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlayerId,Name,Stats,TeamId")] Player player)
        {
